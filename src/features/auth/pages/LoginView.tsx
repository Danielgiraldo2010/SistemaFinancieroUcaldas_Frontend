...
export const LoginView = ({ register, onSubmit, loading, apiError, errors }: LoginViewProps) => {
    ...
    >
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <p className="text-center text-sm text-slate-500 mt-2">
          ...
          <a href="mailto:soporte@ucaldas.edu.co" className="text-ucaldas-gold font-medium hover:underline">
